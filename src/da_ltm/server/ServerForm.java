...
import da_ltm.client.SendFileForm;
...
public class ServerForm extends javax.swing.JFrame {
    ...
    // Tạo cấu trúc form ServerFormWindow
    public ServerForm() {
        initComponents();
    ...
    public void setSocketList(Socket socket){
        try {
            ...
            appendMessage("Danh Sách Socket Được thêm");
        } catch (Exception e) { appendMessage("Danh Sách Socket: "+ e.getMessage()); }
    }
    public void setClientList(String client){
        try {
            clientList.add(client);
            appendMessage("Danh Sach User Được thêm");
        } catch (Exception e) { appendMessage("Danh Sach User "+ e.getMessage()); }
    }
        ...
        try {
            for(int x=0; x < clientList.size(); x++){
                if(clientList.elementAt(x).equals(client)){
                    ...
                    appendMessage(client+" Bị loại khỏi danh sach User ");
                    break;
                }
            }
        } catch (Exception e) {
            appendMessage("User bị loại lỗi: "+ e.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-start-20.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-stop-25.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code when click btn start:
